...
# Data Pipeline
The Targets package is a data pipeline toolkit allowing dependency awareness and rerunning of code that is downstream from dependency changes and nothing more.
...
# Load targets
Once the targets are defined, any rmd within the project directory can access them.
